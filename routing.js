...
routing.load_routes = function (app) {
    ...
    // *********************************************************************************************************************
    // Metadata API Route Mapping
    // *********************************************************************************************************************

    // curl -u public:123456789  -X POST -H "Content-Type: application/json" -d '{"query":""}' http://localhost:3010/metadata/by

    app.post ('/metadata/by',
        passport.authenticate ('basic', { session: false }),
        function (req, res) {
    ...
    // *********************************************************************************************************************
    // Validation API Route Mapping
    // *********************************************************************************************************************

    // curl -u public:123456789  -X POST -H "Content-Type: application/json" -d '{"query":""}' http://localhost:3010/metadata/by/validate

    app.post ('/metadata/by/validate',
        passport.authenticate ('basic', { session: false }),
        function (req, res) {
