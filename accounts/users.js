...
users.getUsers = function getUsers() {
    var users = [
        ...
        { id: 7, username: 'erskine', name: 'Erskine', token: 'd52de5ff-2cc4-4054-83d0-5bdf04311992', email: 'erskine@someplace.com'},
        { id: 8, username: 'pete', name: 'Pete Bakke', token: 'f97dbc35-dacc-4135-a335-dc1d3029b44d', email: 'pete@someplace.com'},
